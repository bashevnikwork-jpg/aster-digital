      ...
      <div class="shell">
        <div class="hero__inner" data-hero>
          ...
          <p class="hero__sub lead">
            ...
            та запускаємо Google Ads, щоб ваш бізнес отримав перших клієнтів з інтернету.
          </p>
      ...
      <div class="shell">
        <div class="head" data-reveal>
          ...
          <p class="lead">
            ...
            налаштовуємо рекламу та допомагаємо запустити весь процес від ідеї до перших звернень.
          </p>
        </div>
      </div>
    ...
    <section class="section section--alt rule" id="why">
      <div class="shell">
        <div class="head" data-reveal>
          ...
          <p class="lead">
            В Astra Digital ми не обмежуємося візуальною подачею — продумуємо сайт як
            інструмент продажів: від структури та текстів до реклами й аналітики.
          </p>
        </div>
      </div>
      <div class="shell shell--bleed">
    ...
    <section class="section rule" id="system">
      <div class="shell">
        <div class="head" data-reveal>
          ...
          <p class="lead">
            Соцмережі можуть бути частиною продажів. Але власний сайт дає вам окрему точку контакту
            з клієнтом, яку можна використовувати в рекламі та пошуку.
          </p>
        </div>
      </div>
      <div class="shell shell--bleed">
      ...
      <div class="shell">
        <div class="head head--center" data-reveal>
          ...
          <p class="lead" style="margin-inline:auto">
            ...
            Покажемо, що можна покращити та з чого варто почати.
          </p>
...
SERVICES = [
    dict(id="web", index="01 — WEB", nav="Створення сайтів", navsub="Landing page та складні проєкти",
         ...
         what="В Astra Digital ми продумуємо сайт як інструмент продажів: формуємо сильну пропозицію, "
    ...
    <section class="section rule" id="services">
      <div class="shell">
        <div class="head" data-reveal>
          ...
          <p class="lead">
            Усередині кожної картки: що це, навіщо це бізнесу, що саме ви отримаєте,
    ...
    <section class="section section--alt rule" id="after">
      <div class="shell">
        <div class="head" data-reveal>
          ...
          <p class="lead">
            Спочатку розбираємося в задачі, а вже потім пропонуємо формат і вартість.
          </p>
        </div>
      </div>
      <div class="shell shell--bleed">
...
work_cells = "\n".join(f'''          <article class="work" data-reveal>
            <div class="work__shot"><img src="public/assets/screenshots/{s}.webp" alt="{n} — проєкт Astra Digital" loading="{l}" /></div>
      ...
      <div class="shell">
        <div data-hero>
          ...
          <p class="lead">
            ...
            та що це дало. Без вигаданих цифр — лише те, що можемо підтвердити.
          </p>
        </div>
      </div>
    </section>
